...
func (x *DatasetReference) Reset() {
	*x = DatasetReference{}
	mi := &file_google_cloud_bigquery_v2_dataset_reference_proto_msgTypes[0]
...
var file_google_cloud_bigquery_v2_dataset_reference_proto_rawDesc = []byte{
	...
	0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5a, 0x0a,
	0x10, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	...
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x42, 0x6f, 0x0a, 0x1c, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x62, 0x69,
	0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x76, 0x32, 0x42, 0x15, 0x44, 0x61, 0x74, 0x61, 0x73,
	0x65, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	...
	file_google_cloud_bigquery_v2_dataset_reference_proto_rawDescData = file_google_cloud_bigquery_v2_dataset_reference_proto_rawDesc
)
...
func file_google_cloud_bigquery_v2_dataset_reference_proto_rawDescGZIP() []byte {
	file_google_cloud_bigquery_v2_dataset_reference_proto_rawDescOnce.Do(func() {
		file_google_cloud_bigquery_v2_dataset_reference_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_cloud_bigquery_v2_dataset_reference_proto_rawDescData)
	})
...
var file_google_cloud_bigquery_v2_dataset_reference_proto_goTypes = []any{
	(*DatasetReference)(nil), // 0: google.cloud.bigquery.v2.DatasetReference
}
var file_google_cloud_bigquery_v2_dataset_reference_proto_depIdxs = []int32{
...
func init() { file_google_cloud_bigquery_v2_dataset_reference_proto_init() }
func file_google_cloud_bigquery_v2_dataset_reference_proto_init() {
	if File_google_cloud_bigquery_v2_dataset_reference_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_cloud_bigquery_v2_dataset_reference_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_cloud_bigquery_v2_dataset_reference_proto_goTypes,
		DependencyIndexes: file_google_cloud_bigquery_v2_dataset_reference_proto_depIdxs,
		MessageInfos:      file_google_cloud_bigquery_v2_dataset_reference_proto_msgTypes,
	}.Build()
	File_google_cloud_bigquery_v2_dataset_reference_proto = out.File
	file_google_cloud_bigquery_v2_dataset_reference_proto_rawDesc = nil
	file_google_cloud_bigquery_v2_dataset_reference_proto_goTypes = nil
	file_google_cloud_bigquery_v2_dataset_reference_proto_depIdxs = nil
}
