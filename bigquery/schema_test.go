...
[
	...
	{"name":"flat_interval","type":"INTERVAL","mode":"REQUIRED","description":"Flat reqiured INTERVAL"},
	...
	{"name":"aliased_bignumeric","type":"BIGDECIMAL","mode":"NULLABLE","description":"Aliased nullable bignumeric"}
			...
			expectedSchema: Schema{
				...
				fieldSchema("Flat required INTERVAL", "flat_interval", "INTERVAL", false, true, nil),
