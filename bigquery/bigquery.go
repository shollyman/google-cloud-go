...
// runQuery executes a query via the jobs.query API, which differs from the more generalized jobs.insert
// path and has optimizations for reducing end to end query latency.
