...
type HivePartitioningOptions struct {
	...
	xxx_hidden_SourceUriPrefix        string                 `protobuf:"bytes,2,opt,name=source_uri_prefix,json=sourceUriPrefix,proto3"`
	xxx_hidden_RequirePartitionFilter *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=require_partition_filter,json=requirePartitionFilter,proto3"`
...
func (x *HivePartitioningOptions) GetSourceUriPrefix() string {
	if x != nil {
		return x.xxx_hidden_SourceUriPrefix
	}
	return ""
}
...
func (x *HivePartitioningOptions) SetSourceUriPrefix(v string) {
	x.xxx_hidden_SourceUriPrefix = v
}
...
func (b0 HivePartitioningOptions_builder) Build() *HivePartitioningOptions {
	...
	x.xxx_hidden_SourceUriPrefix = b.SourceUriPrefix
