...
type ErrorProto struct {
	...
	xxx_hidden_Location  string                 `protobuf:"bytes,2,opt,name=location,proto3"`
	xxx_hidden_DebugInfo string                 `protobuf:"bytes,3,opt,name=debug_info,json=debugInfo,proto3"`
...
const file_google_cloud_bigquery_v2_error_proto_rawDesc = "" +
	"\n" +
	"$google/cloud/bigquery/v2/error.proto\x12\x18google.cloud.bigquery.v2\"y\n" +
	"\n" +
	"ErrorProto\x12\x16\n" +
...
func file_google_cloud_bigquery_v2_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_v2_error_proto_rawDesc), len(file_google_cloud_bigquery_v2_error_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
