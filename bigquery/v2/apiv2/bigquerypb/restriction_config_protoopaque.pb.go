...
type RestrictionConfig struct {
	...
	xxx_hidden_Type RestrictionConfig_RestrictionType `protobuf:"varint,1,opt,name=type,proto3,enum=google.cloud.bigquery.v2.RestrictionConfig_RestrictionType"`
