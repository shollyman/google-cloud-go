...
type StandardSqlDataType struct {
	...
	xxx_hidden_TypeKind StandardSqlDataType_TypeKind  `protobuf:"varint,1,opt,name=type_kind,json=typeKind,proto3,enum=google.cloud.bigquery.v2.StandardSqlDataType_TypeKind"`
	xxx_hidden_SubType  isStandardSqlDataType_SubType `protobuf_oneof:"sub_type"`
...
func (x *StandardSqlDataType) GetArrayElementType() *StandardSqlDataType {
	if x != nil {
		if x, ok := x.xxx_hidden_SubType.(*standardSqlDataType_ArrayElementType); ok {
...
func (x *StandardSqlDataType) GetStructType() *StandardSqlStructType {
	if x != nil {
		if x, ok := x.xxx_hidden_SubType.(*standardSqlDataType_StructType); ok {
			return x.StructType
		}
	}
	return nil
...
func (x *StandardSqlDataType) GetRangeElementType() *StandardSqlDataType {
	if x != nil {
		if x, ok := x.xxx_hidden_SubType.(*standardSqlDataType_RangeElementType); ok {
...
func (x *StandardSqlDataType) SetArrayElementType(v *StandardSqlDataType) {
	...
	x.xxx_hidden_SubType = &standardSqlDataType_ArrayElementType{v}
}
...
func (x *StandardSqlDataType) SetStructType(v *StandardSqlStructType) {
	...
	x.xxx_hidden_SubType = &standardSqlDataType_StructType{v}
}
...
func (x *StandardSqlDataType) SetRangeElementType(v *StandardSqlDataType) {
	...
	x.xxx_hidden_SubType = &standardSqlDataType_RangeElementType{v}
}
...
func (x *StandardSqlDataType) HasSubType() bool {
	...
	return x.xxx_hidden_SubType != nil
}
...
func (x *StandardSqlDataType) HasArrayElementType() bool {
	...
	_, ok := x.xxx_hidden_SubType.(*standardSqlDataType_ArrayElementType)
	return ok
}
...
func (x *StandardSqlDataType) HasStructType() bool {
	...
	_, ok := x.xxx_hidden_SubType.(*standardSqlDataType_StructType)
	return ok
}
...
func (x *StandardSqlDataType) HasRangeElementType() bool {
	...
	_, ok := x.xxx_hidden_SubType.(*standardSqlDataType_RangeElementType)
	return ok
}
...
func (x *StandardSqlDataType) ClearArrayElementType() {
	if _, ok := x.xxx_hidden_SubType.(*standardSqlDataType_ArrayElementType); ok {
		x.xxx_hidden_SubType = nil
	}
}

func (x *StandardSqlDataType) ClearStructType() {
	if _, ok := x.xxx_hidden_SubType.(*standardSqlDataType_StructType); ok {
		x.xxx_hidden_SubType = nil
	}
}

func (x *StandardSqlDataType) ClearRangeElementType() {
	if _, ok := x.xxx_hidden_SubType.(*standardSqlDataType_RangeElementType); ok {
		x.xxx_hidden_SubType = nil
	}
}
...
func (x *StandardSqlDataType) WhichSubType() case_StandardSqlDataType_SubType {
	...
	switch x.xxx_hidden_SubType.(type) {
...
type StandardSqlDataType_builder struct {
	...
	// Fields of oneof xxx_hidden_SubType:
...
func (b0 StandardSqlDataType_builder) Build() *StandardSqlDataType {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_TypeKind = b.TypeKind
	if b.ArrayElementType != nil {
		x.xxx_hidden_SubType = &standardSqlDataType_ArrayElementType{b.ArrayElementType}
	}
	if b.StructType != nil {
		x.xxx_hidden_SubType = &standardSqlDataType_StructType{b.StructType}
	}
	if b.RangeElementType != nil {
		x.xxx_hidden_SubType = &standardSqlDataType_RangeElementType{b.RangeElementType}
	}
	return m0
}
...
type StandardSqlStructType struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Fields *[]*StandardSqlField   `protobuf:"bytes,1,rep,name=fields,proto3"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type StandardSqlTableType struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Columns *[]*StandardSqlField   `protobuf:"bytes,1,rep,name=columns,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
