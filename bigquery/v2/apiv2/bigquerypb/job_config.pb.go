...
type JobConfigurationQuery struct {
	...
	ExternalTableDefinitions map[string]*ExternalDataConfiguration `protobuf:"bytes,23,rep,name=external_table_definitions,json=tableDefinitions,proto3" json:"external_table_definitions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type JobConfigurationLoad struct {
	...
	TimestampTargetPrecision []int32 `protobuf:"varint,59,rep,packed,name=timestamp_target_precision,json=timestampTargetPrecision,proto3" json:"timestamp_target_precision,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *JobConfigurationExtract) GetSourceTable() *TableReference {
	if x != nil {
		if x, ok := x.Source.(*JobConfigurationExtract_SourceTable); ok {
			return x.SourceTable
		}
	}
	return nil
...
func (x *JobConfigurationExtract) GetSourceModel() *ModelReference {
	if x != nil {
		if x, ok := x.Source.(*JobConfigurationExtract_SourceModel); ok {
