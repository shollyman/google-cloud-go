...
func (x *ModelReference) SetProjectId(v string) {
	x.xxx_hidden_ProjectId = v
}

func (x *ModelReference) SetDatasetId(v string) {
	x.xxx_hidden_DatasetId = v
}

func (x *ModelReference) SetModelId(v string) {
	x.xxx_hidden_ModelId = v
}

type ModelReference_builder struct {
...
func (b0 ModelReference_builder) Build() *ModelReference {
	m0 := &ModelReference{}
	b, x := &b0, m0
	_, _ = b, x
...
const file_google_cloud_bigquery_v2_model_reference_proto_rawDesc = "" +
	"\n" +
	".google/cloud/bigquery/v2/model_reference.proto\x12\x18google.cloud.bigquery.v2\x1a\x1fgoogle/api/field_behavior.proto\"x\n" +
	...
	"\bmodel_id\x18\x03 \x01(\tB\x03\xe0A\x02R\amodelIdBp\n" +
...
var file_google_cloud_bigquery_v2_model_reference_proto_goTypes = []any{
...
func file_google_cloud_bigquery_v2_model_reference_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_bigquery_v2_model_reference_proto_rawDesc), len(file_google_cloud_bigquery_v2_model_reference_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
