...
type BigLakeConfiguration struct {
	...
	xxx_hidden_StorageUri   string                           `protobuf:"bytes,2,opt,name=storage_uri,json=storageUri,proto3"`
	xxx_hidden_FileFormat   BigLakeConfiguration_FileFormat  `protobuf:"varint,3,opt,name=file_format,json=fileFormat,proto3,enum=google.cloud.bigquery.v2.BigLakeConfiguration_FileFormat"`
	xxx_hidden_TableFormat  BigLakeConfiguration_TableFormat `protobuf:"varint,4,opt,name=table_format,json=tableFormat,proto3,enum=google.cloud.bigquery.v2.BigLakeConfiguration_TableFormat"`
...
func (x *BigLakeConfiguration) GetStorageUri() string {
	if x != nil {
		return x.xxx_hidden_StorageUri
	}
	return ""
}
...
func (x *BigLakeConfiguration) GetTableFormat() BigLakeConfiguration_TableFormat {
	if x != nil {
		return x.xxx_hidden_TableFormat
	}
...
func (b0 BigLakeConfiguration_builder) Build() *BigLakeConfiguration {
	...
	x.xxx_hidden_StorageUri = b.StorageUri
	x.xxx_hidden_FileFormat = b.FileFormat
	x.xxx_hidden_TableFormat = b.TableFormat
	return m0
}
