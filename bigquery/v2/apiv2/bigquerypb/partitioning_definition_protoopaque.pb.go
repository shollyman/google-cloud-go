...
type PartitioningDefinition struct {
	...
	xxx_hidden_PartitionedColumn *[]*PartitionedColumn  `protobuf:"bytes,1,rep,name=partitioned_column,json=partitionedColumn,proto3"`
...
func (x *PartitioningDefinition) GetPartitionedColumn() []*PartitionedColumn {
	if x != nil {
		if x.xxx_hidden_PartitionedColumn != nil {
			return *x.xxx_hidden_PartitionedColumn
		}
	}
	return nil
}
...
func (x *PartitioningDefinition) SetPartitionedColumn(v []*PartitionedColumn) {
	x.xxx_hidden_PartitionedColumn = &v
}
...
func (b0 PartitioningDefinition_builder) Build() *PartitioningDefinition {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_PartitionedColumn = &b.PartitionedColumn
	return m0
}
...
type PartitionedColumn struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Field       *string                `protobuf:"bytes,1,opt,name=field,proto3,oneof"`
