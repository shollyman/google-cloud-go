...
type ArrowSchema struct {
	...
	xxx_hidden_SerializedSchema []byte                 `protobuf:"bytes,1,opt,name=serialized_schema,json=serializedSchema,proto3"`
...
func (x *ArrowSchema) GetSerializedSchema() []byte {
	if x != nil {
		return x.xxx_hidden_SerializedSchema
	}
	return nil
}

func (x *ArrowSchema) SetSerializedSchema(v []byte) {
	if v == nil {
		v = []byte{}
	}
	x.xxx_hidden_SerializedSchema = v
}

type ArrowSchema_builder struct {
...
func (b0 ArrowSchema_builder) Build() *ArrowSchema {
	m0 := &ArrowSchema{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SerializedSchema = b.SerializedSchema
	return m0
}
...
type ArrowRecordBatch struct {
	state                            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SerializedRecordBatch []byte                 `protobuf:"bytes,1,opt,name=serialized_record_batch,json=serializedRecordBatch,proto3"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *ArrowRecordBatch) GetSerializedRecordBatch() []byte {
	if x != nil {
		return x.xxx_hidden_SerializedRecordBatch
	}
	return nil
}

func (x *ArrowRecordBatch) SetSerializedRecordBatch(v []byte) {
	if v == nil {
		v = []byte{}
	}
	x.xxx_hidden_SerializedRecordBatch = v
}

type ArrowRecordBatch_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// IPC-serialized Arrow RecordBatch.
	SerializedRecordBatch []byte
}

func (b0 ArrowRecordBatch_builder) Build() *ArrowRecordBatch {
	m0 := &ArrowRecordBatch{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_SerializedRecordBatch = b.SerializedRecordBatch
	return m0
}
...
type ArrowSerializationOptions struct {
	state                              protoimpl.MessageState                            `protogen:"opaque.v1"`
	xxx_hidden_BufferCompression       ArrowSerializationOptions_CompressionCodec        `protobuf:"varint,2,opt,name=buffer_compression,json=bufferCompression,proto3,enum=google.cloud.bigquery.v2.ArrowSerializationOptions_CompressionCodec"`
	xxx_hidden_PicosTimestampPrecision ArrowSerializationOptions_PicosTimestampPrecision `protobuf:"varint,3,opt,name=picos_timestamp_precision,json=picosTimestampPrecision,proto3,enum=google.cloud.bigquery.v2.ArrowSerializationOptions_PicosTimestampPrecision"`
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
}
...
func (x *ArrowSerializationOptions) GetBufferCompression() ArrowSerializationOptions_CompressionCodec {
	if x != nil {
		return x.xxx_hidden_BufferCompression
	}
...
func (x *ArrowSerializationOptions) GetPicosTimestampPrecision() ArrowSerializationOptions_PicosTimestampPrecision {
	if x != nil {
		return x.xxx_hidden_PicosTimestampPrecision
	}
	return ArrowSerializationOptions_PICOS_TIMESTAMP_PRECISION_UNSPECIFIED
}

func (x *ArrowSerializationOptions) SetBufferCompression(v ArrowSerializationOptions_CompressionCodec) {
	x.xxx_hidden_BufferCompression = v
}

func (x *ArrowSerializationOptions) SetPicosTimestampPrecision(v ArrowSerializationOptions_PicosTimestampPrecision) {
	x.xxx_hidden_PicosTimestampPrecision = v
}

type ArrowSerializationOptions_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
	...
	// is microseconds.
	PicosTimestampPrecision ArrowSerializationOptions_PicosTimestampPrecision
}

func (b0 ArrowSerializationOptions_builder) Build() *ArrowSerializationOptions {
	m0 := &ArrowSerializationOptions{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_BufferCompression = b.BufferCompression
	x.xxx_hidden_PicosTimestampPrecision = b.PicosTimestampPrecision
	return m0
}
